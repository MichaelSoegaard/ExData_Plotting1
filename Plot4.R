...
# We open a .png writer, make the plots and then closes the writer again 
...
# PLOT 4
plot(sub_data$Time, sub_data$Global_reactive_power, type = "l", ylab = "Global_reactive_power",
     xlab = "datetime")
